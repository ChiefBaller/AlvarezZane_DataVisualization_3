...
public class AlvarezZane_DataVisualization_3 extends PApplet {
...
public void draw() {
  ...
  public void settings() {  size(1300, 680); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "AlvarezZane_DataVisualization_3" };
    if (passedArgs != null) {
